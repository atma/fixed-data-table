...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define(["react", "classnames", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["FixedDataTable"] = factory(require("react"), require("classnames"), require("react-dom"));
	else
		root["FixedDataTable"] = factory(root["React"], root["classnames"], root["ReactDOM"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_53__) {
...
var _translateDOMPositionXY = __webpack_require__(58);
...
var _nativeRequestAnimationFrame = __webpack_require__(51);
...
var DOMMouseMoveTracker = function () {
   ...
   */
  function DOMMouseMoveTracker(onMove, onMoveEnd, domNode, touchEnabled) {
...
var _normalizeWheel = __webpack_require__(48);
...
var ReactWheelHandler = function () {
   ...
   * this order
   */
  function ReactWheelHandler(onWheel, handleScrollX, handleScrollY, stopPropagation) {
...
var _DOMMouseMoveTracker = __webpack_require__(25);
...
var _ReactWheelHandler = __webpack_require__(29);

var _ReactWheelHandler2 = _interopRequireDefault(_ReactWheelHandler);

var _cssVar = __webpack_require__(57);
...
var _FixedDataTableTranslateDOMPosition = __webpack_require__(7);
...
var Scrollbar = function (_PureComponent) {
  ...
  function Scrollbar(props) {
    ...
    _this._calculateState = _this._calculateState.bind(_this);
    _this._onBlur = _this._onBlur.bind(_this);
    _this._onFocus = _this._onFocus.bind(_this);
    _this._onKeyDown = _this._onKeyDown.bind(_this);
    _this._onMouseDown = _this._onMouseDown.bind(_this);
    _this._onMouseMove = _this._onMouseMove.bind(_this);
    _this._onMouseMoveEnd = _this._onMouseMoveEnd.bind(_this);
  ...
  _createClass(Scrollbar, [{
    ...
    value: function render() /*?object*/{
      ...
      var mainClassName = (0, _classnames2.default)({
      ...
      var faceClassName = (0, _classnames2.default)({
    ...
    key: 'scrollBy',
    value: function scrollBy( /*number*/delta) {
      this._onWheel(delta);
    }
  }, {
    key: '_shouldHandleX',
    value: function _shouldHandleX( /*number*/delta) /*boolean*/{
      return this.props.orientation === 'horizontal' ? this._shouldHandleChange(delta) : false;
    }
  }, {
    key: '_shouldHandleY',
    value: function _shouldHandleY( /*number*/delta) /*boolean*/{
      return this.props.orientation !== 'horizontal' ? this._shouldHandleChange(delta) : false;
    }
  }, {
    key: '_shouldHandleChange',
    value: function _shouldHandleChange( /*number*/delta) /*boolean*/{
    ...
    key: '_calculateState',
    value: function _calculateState( /*number*/position,
    /*number*/size,
    /*number*/contentSize,
    ...
    key: '_onWheelY',
    value: function _onWheelY( /*number*/deltaX, /*number*/deltaY) {
      this._onWheel(deltaY);
    }
  }, {
    key: '_onWheelX',
    value: function _onWheelX( /*number*/deltaX, /*number*/deltaY) {
      this._onWheel(deltaX);
    }
  }, {
    key: '_onWheel',
    value: function _onWheel( /*number*/delta) {
    ...
    key: '_onMouseDown',
    value: function _onMouseDown( /*object*/event) {
      var nextState;

      if (event.target !== _reactDom2.default.findDOMNode(this.faceEl)) {
    ...
    key: '_onMouseMove',
    value: function _onMouseMove( /*number*/deltaX, /*number*/deltaY) {
      var props = this.props;
    ...
    key: '_onMouseMoveEnd',
    value: function _onMouseMoveEnd() {
      this._nextState = null;
      this._mouseMoveTracker.releaseMouseMoves();
    ...
    key: '_setNextState',
    value: function _setNextState( /*object*/nextState, /*?object*/props) {
...
var _FixedDataTableCellGroup = __webpack_require__(65);
  ...
  function FixedDataTableRowImpl() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FixedDataTableRowImpl.__proto__ || Object.getPrototypeOf(FixedDataTableRowImpl)).call.apply(_ref, [this].concat(args))), _this), _this.mouseLeaveIndex = null, _this._getColumnsWidth = function ( /*array*/columns) /*number*/{
      ...
      var className = (0, _classnames2.default)({
        ...
        'fixedDataTableRowLayout_columnsShadow': _this.props.scrollLeft > 0,
        'public_fixedDataTableRow_fixedColumnsDivider': left > 0,
        'public_fixedDataTableRow_columnsShadow': _this.props.scrollLeft > 0
      });
      ...
      var className = (0, _classnames2.default)('fixedDataTableRowLayout_columnsShadow', 'fixedDataTableRowLayout_columnsRightShadow', 'fixedDataTableRowLayout_fixedColumnsDivider', 'public_fixedDataTableRow_columnsShadow', 'public_fixedDataTableRow_columnsRightShadow', 'public_fixedDataTableRow_fixedColumnsDivider');
      var style = {
      ...
      if (Math.ceil(_this.props.scrollLeft + _this.props.width) < Math.floor(totalWidth)) {
        var className = (0, _classnames2.default)('fixedDataTableRowLayout_columnsShadow', 'fixedDataTableRowLayout_columnsRightShadow', 'public_fixedDataTableRow_columnsShadow', 'public_fixedDataTableRow_columnsRightShadow');
        var style = {
          height: _this.props.height
        };
        return _react2.default.createElement('div', { className: className, style: style });
    ...
    value: function render() /*object*/{
      ...
      if (this.props.showScrollbarY) {
        ...
        scrollbarSpacer = _react2.default.createElement('div', {
          style: spacerStyles,
          className: (0, _classnames2.default)('public_fixedDataTable_scrollbarSpacer')
        });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)('fixedDataTableRowLayout_body') },
          fixedColumns,
          scrollableColumns,
          columnsLeftShadow,
          fixedRightColumns,
        ...
        rowExpanded && _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)('fixedDataTableRowLayout_rowExpanded'),
  ...
  _createClass(FixedDataTableRow, [{
    ...
    value: function render() /*object*/{
      ...
      return _react2.default.createElement(
        ...
        {
          style: style,
          className: (0, _classnames2.default)('fixedDataTableRowLayout_rowWrapper') },
  ...
  _createClass(FixedDataTableCellDefault, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({}, props, {
          className: (0, _classnames2.default)('fixedDataTableCellLayout_wrap', 'public_fixedDataTableCell_wrap', className),
          style: innerStyle }),
        _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)('public_fixedDataTableCell_cellContent') },
          children
        )
      );
    }
...
FixedDataTableRoot.version = '1.0.0';
...
var _ReactTouchHandler = __webpack_require__(52);
...
var _FixedDataTableBufferedRows = __webpack_require__(61);

var _FixedDataTableBufferedRows2 = _interopRequireDefault(_FixedDataTableBufferedRows);

var _FixedDataTableColumnResizeHandle = __webpack_require__(68);
...
var _FixedDataTableScrollHelper = __webpack_require__(69);

var _FixedDataTableScrollHelper2 = _interopRequireDefault(_FixedDataTableScrollHelper);

var _FixedDataTableWidthHelper = __webpack_require__(71);
...
var _debounceCore = __webpack_require__(72);
...
var FixedDataTable = function (_Component) {
  _inherits(FixedDataTable, _Component);

  function FixedDataTable(props) {
    _classCallCheck(this, FixedDataTable);

    var _this = _possibleConstructorReturn(this, (FixedDataTable.__proto__ || Object.getPrototypeOf(FixedDataTable)).call(this, props));

    _this._didScrollStart = _this._didScrollStart.bind(_this);
    _this._onColumnReorder = _this._onColumnReorder.bind(_this);
    _this._onColumnReorderMove = _this._onColumnReorderMove.bind(_this);
    _this._onColumnReorderEnd = _this._onColumnReorderEnd.bind(_this);
    _this._onColumnResize = _this._onColumnResize.bind(_this);
    _this._onHorizontalScroll = _this._onHorizontalScroll.bind(_this);
    _this._onKeyDown = _this._onKeyDown.bind(_this);
    _this._onScroll = _this._onScroll.bind(_this);
    _this._onVerticalScroll = _this._onVerticalScroll.bind(_this);
    _this._shouldHandleTouchX = _this._shouldHandleTouchX.bind(_this);
    _this._shouldHandleTouchY = _this._shouldHandleTouchY.bind(_this);
    _this._shouldHandleWheelX = _this._shouldHandleWheelX.bind(_this);
    _this._shouldHandleWheelY = _this._shouldHandleWheelY.bind(_this);
    return _this;
  }
  ...
  _createClass(FixedDataTable, [{
    ...
    key: '_shouldHandleTouchX',
    value: function _shouldHandleTouchX( /*number*/delta) /*boolean*/{
      return this.props.touchScrollEnabled && this._shouldHandleWheelX(delta);
    }
  }, {
    key: '_shouldHandleTouchY',
    value: function _shouldHandleTouchY( /*number*/delta) /*boolean*/{
    ...
    value: function render() /*object*/{
      ...
      if (state.useGroupHeader) {
        groupHeader = _react2.default.createElement(_FixedDataTableRow2.default, {
          ...
          className: (0, _classnames2.default)('fixedDataTableLayout_header', 'public_fixedDataTable_header'),
          width: state.width,
      ...
      if (state.footerHeight) {
        footer = _react2.default.createElement(_FixedDataTableRow2.default, {
          key: 'footer',
          isScrolling: this._isScrolling,
          className: (0, _classnames2.default)('fixedDataTableLayout_footer', 'public_fixedDataTable_footer'),
          width: state.width,
      ...
      if (state.scrollY) {
        topShadow = _react2.default.createElement('div', {
          className: (0, _classnames2.default)('fixedDataTableLayout_topShadow', 'public_fixedDataTable_topShadow'),
      ...
      if (state.ownerHeight != null && state.ownerHeight < state.height && state.scrollContentHeight + state.reservedHeight > state.ownerHeight || state.scrollY < maxScrollY) {
        bottomShadow = _react2.default.createElement('div', {
          className: (0, _classnames2.default)('fixedDataTableLayout_bottomShadow', 'public_fixedDataTable_bottomShadow'),
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)(this.state.className, 'fixedDataTableLayout_main', 'public_fixedDataTable_main'),
          tabIndex: 0,
          onKeyDown: this._onKeyDown,
          onWheel: this._wheelHandler.onWheel,
        ...
        _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)('fixedDataTableLayout_rowsContainer'),
    ...
    key: '_onColumnReorder',
    value: function _onColumnReorder(
    /*string*/columnKey,
    /*number*/width,
    /*number*/left,
    /*object*/event) {
    ...
    key: '_onColumnReorderMove',
    value: function _onColumnReorderMove(
    /*number*/deltaX) {
    ...
    key: '_onColumnReorderEnd',
    value: function _onColumnReorderEnd(
    /*object*/props,
    /*object*/event) {
    ...
    key: '_showScrollbarY',
    value: function _showScrollbarY( /*object*/state) {
    ...
    key: '_onScroll',
    value: function _onScroll( /*number*/deltaX, /*number*/deltaY) {
    ...
    key: '_didScrollStopSync',
    value: function _didScrollStopSync() {
      if (!this._isScrolling) {
        return;
      }
...
var HorizontalScrollbar = function (_PureComponent) {
  _inherits(HorizontalScrollbar, _PureComponent);
  ...
  _createClass(HorizontalScrollbar, [{
    ...
    value: function render() /*object*/{
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)('fixedDataTableLayout_horizontalScrollbar', 'public_fixedDataTable_horizontalScrollbar'),
...
var _UserAgent_DEPRECATED = __webpack_require__(49);
...
var _BrowserSupportCore = __webpack_require__(59);
...
var _FixedDataTableRowBuffer = __webpack_require__(62);
...
var FixedDataTableBufferedRows = function (_Component) {
  _inherits(FixedDataTableBufferedRows, _Component);

  function FixedDataTableBufferedRows(props) {
    _classCallCheck(this, FixedDataTableBufferedRows);

    var _this = _possibleConstructorReturn(this, (FixedDataTableBufferedRows.__proto__ || Object.getPrototypeOf(FixedDataTableBufferedRows)).call(this, props));

    _this._getRowHeight = _this._getRowHeight.bind(_this);

    _this._rowBuffer = new _FixedDataTableRowBuffer2.default(_this.props.rowsCount, _this.props.defaultRowHeight, _this.props.height, _this._getRowHeight, _this.props.bufferRowCount);

    _this.state = {
      rowsToRender: _this._rowBuffer.getRows(_this.props.firstRowIndex, _this.props.firstRowOffset)
    };

    _this._getSubRowHeight = _this._getSubRowHeight.bind(_this);
    _this._updateBuffer = _this._updateBuffer.bind(_this);
    return _this;
  }
  ...
  _createClass(FixedDataTableBufferedRows, [{
    ...
    key: '_getRowHeight',
    value: function _getRowHeight( /*number*/index) /*number*/{
      return this.props.rowHeightGetter ? this.props.rowHeightGetter(index) : this.props.defaultRowHeight;
    }
  }, {
    key: '_getSubRowHeight',
    value: function _getSubRowHeight( /*number*/index) /*number*/{
...
var _IntegerBufferSet = __webpack_require__(63);
...
var _Heap = __webpack_require__(64);
...
var IntegerBufferSet = function () {
  ...
  _createClass(IntegerBufferSet, [{
    ...
    value: function getValuePosition(value) {
    ...
    value: function getNewPositionForValue(value) {
    ...
    value: function replaceFurthestValuePosition(lowValue, highValue, newValue) {
    ...
    key: '_pushToHeaps',
    value: function _pushToHeaps(position, value) {
      var element = {
        position: position,
        value: value
      };
    ...
    key: '_cleanHeap',
    value: function _cleanHeap(heap) {
    ...
    value: function _smallerComparator(lhs, rhs) {
      return lhs.value < rhs.value;
    }
  }, {
    key: '_greaterComparator',
    value: function _greaterComparator(lhs, rhs) {
      return lhs.value > rhs.value;
    }
  }]);
...
var _FixedDataTableCell = __webpack_require__(66);
...
var FixedDataTableCellGroupImpl = function (_Component) {
  _inherits(FixedDataTableCellGroupImpl, _Component);

  function FixedDataTableCellGroupImpl() {
    _classCallCheck(this, FixedDataTableCellGroupImpl);

    return _possibleConstructorReturn(this, (FixedDataTableCellGroupImpl.__proto__ || Object.getPrototypeOf(FixedDataTableCellGroupImpl)).apply(this, arguments));
  }
  ...
  _createClass(FixedDataTableCellGroupImpl, [{
    ...
    value: function render() /*object*/{
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)('fixedDataTableCellGroupLayout_cellGroup'),
          style: style },
        cells
      );
    }
    ...
    value: function _getColumnsWidth( /*array*/columns) /*number*/{
      var width = 0;
      for (var i = 0; i < columns.length; ++i) {
        width += columns[i].props.width;
      }
...
var FixedDataTableCellGroup = function (_Component2) {
  _inherits(FixedDataTableCellGroup, _Component2);
  ...
  function FixedDataTableCellGroup(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, (FixedDataTableCellGroup.__proto__ || Object.getPrototypeOf(FixedDataTableCellGroup)).call(this, props));

    _this2._onColumnResize = _this2._onColumnResize.bind(_this2);
    return _this2;
  }
  ...
  _createClass(FixedDataTableCellGroup, [{
    ...
    value: function render() /*object*/{
      ...
      return _react2.default.createElement(
        ...
        {
          style: style,
          className: (0, _classnames2.default)('fixedDataTableCellGroupLayout_cellGroupWrapper') },
...
var _FixedDataTableColumnReorderHandle = __webpack_require__(67);
...
var FixedDataTableCell = function (_Component) {
  _inherits(FixedDataTableCell, _Component);
   ...
   * development, but please don't commit this component with enabled propTypes.
   */
  function FixedDataTableCell(props) {
    _classCallCheck(this, FixedDataTableCell);

    var _this = _possibleConstructorReturn(this, (FixedDataTableCell.__proto__ || Object.getPrototypeOf(FixedDataTableCell)).call(this, props));
    ...
    _this._onColumnReorderMouseDown = _this._onColumnReorderMouseDown.bind(_this);
    _this._onColumnResizerMouseDown = _this._onColumnResizerMouseDown.bind(_this);
    return _this;
  }
  ...
  _createClass(FixedDataTableCell, [{
    ...
    value: function render() {
      ...
      if (props.onColumnResize) {
        ...
        columnResizerComponent = _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)('fixedDataTableCellLayout_columnResizerContainer'),
          ...
          _react2.default.createElement('div', {
            className: (0, _classnames2.default)('fixedDataTableCellLayout_columnResizerKnob', 'public_fixedDataTableCell_columnResizerKnob'),
            style: columnResizerStyle
          })
        );
      }
    ...
    key: '_onColumnResizerMouseDown',
    value: function _onColumnResizerMouseDown(event) {
    ...
    key: '_onColumnReorderMouseDown',
    value: function _onColumnReorderMouseDown(event) {
...
FixedDataTableCell.defaultProps = DEFAULT_PROPS;
...
var FixedDataTableColumnReorderHandle = function (_PureComponent) {
  _inherits(FixedDataTableColumnReorderHandle, _PureComponent);

  function FixedDataTableColumnReorderHandle(props) {
    _classCallCheck(this, FixedDataTableColumnReorderHandle);

    var _this = _possibleConstructorReturn(this, (FixedDataTableColumnReorderHandle.__proto__ || Object.getPrototypeOf(FixedDataTableColumnReorderHandle)).call(this, props));
  ...
  _createClass(FixedDataTableColumnReorderHandle, [{
    ...
    key: '_onColumnReorderEnd',
    value: function _onColumnReorderEnd( /*boolean*/cancelReorder) {
...
var FixedDataTableColumnResizeHandle = function (_PureComponent) {
  _inherits(FixedDataTableColumnResizeHandle, _PureComponent);

  function FixedDataTableColumnResizeHandle(props) {
    _classCallCheck(this, FixedDataTableColumnResizeHandle);

    var _this = _possibleConstructorReturn(this, (FixedDataTableColumnResizeHandle.__proto__ || Object.getPrototypeOf(FixedDataTableColumnResizeHandle)).call(this, props));
    ...
    _this._onMove = _this._onMove.bind(_this);
    _this._onColumnResizeEnd = _this._onColumnResizeEnd.bind(_this);
    return _this;
  }
    ...
    value: function render() /*object*/{
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          style: style },
        _react2.default.createElement('div', {
          className: (0, _classnames2.default)('fixedDataTableColumnResizerLineLayout_mouseArea'),
...
var _PrefixIntervalTree = __webpack_require__(70);
