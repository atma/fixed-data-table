...
import { isElement, renderIntoDocument, findRenderedComponentWithType } from 'react-dom/test-utils';
...
describe('FixedDataTableRoot', function() {
  describe('render ', function() {
    it('should not crash and burn', function() {
      ...
      const tableRender = renderer.getRenderOutput();
